	...
	<div class="Body">
      ...
      <div class="GlemtDiv">
        ...
        <table>
          ...
          <tr>
            <td class="SendTo">
              <input title="Viser ikke nøyaktig antall *" value="<?php global $email; echo $email; ?>" disabled><br>
            </td>
          </tr>
          <tr class="GlemtBtn">
            <td><button tabindex="1" type="button" href="mailto:<?php global $email; echo $email; ?>" >Send kode</button></td>
          </tr>
        </table>
